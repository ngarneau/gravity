...
(function() {
	...
	Function.prototype.bind || (Function.prototype.bind = function(ctx) {
		if (typeof this !== 'function') throw _typeError("'this' is not a function");
		var fn = this,
	...
	Object.keys || (Object.keys = function(obj) {
		if (!_isObject(obj)) throw _typeError(obj + " is not an object");
	...
	Object.create || (Object.create = function(proto, properties) {
		if (!_isObject(proto)) throw _typeError(proto + " is not an object");
	...
	$AP.indexOf || ($AP.indexOf = function(searchElement) {
		...
		for (; i < len; ++i) {
			if (this.hasOwnProperty(String(i)) && this[i] === searchElement) return i;
		}
	...
	$AP.every || ($AP.every = function(callback) {
		if (typeof callback !== 'function') throw _typeError(callback + " is not a function");
	...
	$AP.reduce || ($AP.reduce = function(callback) {
		...
		var len = this.length;
		if (len === 0 && arguments.length < 2) throw _typeError("reduce of empty array with no initial value");

		var initIdx = -1;
		if (arguments.length < 2) {
			if ((initIdx = _firstIndex(this)) === -1) throw _typeError("reduce of empty array with no initial value");
		}
	...
	$AP.reduceRight || ($AP.reduceRight = function(callback) {
		...
		if (arguments.length < 2) {
			...
			if (initIdx === len) throw _typeError("reduce of empty array with no initial value");
		}
	...
	Date.prototype.toJSON || (Date.prototype.toJSON = function(key) {
		...
		if (!this.toISOString || typeof this.toISOString !== 'function') throw _typeError("Date.prototype.toJSON called on incompatible " + (typeof this));
